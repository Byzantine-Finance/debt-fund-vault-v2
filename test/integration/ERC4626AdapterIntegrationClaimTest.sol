...
contract ERC4626AdapterIntegrationClaimTest is ERC4626AdapterIntegrationTest {
    ...
    function setUp() public virtual override {
        ...
        erc4626Adapter = IERC4626Adapter(erc4626AdapterFactory.createERC4626Adapter(vaultAddr, address(stataUSDC)));
    ...
    function testClaim() public {
        vm.expectEmit();
        emit IERC4626Adapter.ClaimRewards(rewardToken, rewardAmount);

        vm.expectEmit();
        emit IERC4626Adapter.SwapRewards(lifiDiamond, rewardToken, rewardAmount, swapData);
