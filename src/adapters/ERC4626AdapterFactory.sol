...
contract ERC4626AdapterFactory is IERC4626AdapterFactory {
    ...
    function createERC4626Adapter(address parentVault, address erc4626Vault, address merklDistributor) external returns (address) {
        address _erc4626Adapter = address(new ERC4626Adapter{salt: bytes32(0)}(parentVault, erc4626Vault, merklDistributor));
